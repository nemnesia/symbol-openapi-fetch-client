 ...
 */
export function instanceOfEmbeddedMosaicSupplyRevocationTransactionDTO(
  value: object
): value is EmbeddedMosaicSupplyRevocationTransactionDTO {
...
export function EmbeddedMosaicSupplyRevocationTransactionDTOFromJSONTyped(
  json: any,
...
export function EmbeddedMosaicSupplyRevocationTransactionDTOToJSONTyped(
  value?: EmbeddedMosaicSupplyRevocationTransactionDTO | null,
