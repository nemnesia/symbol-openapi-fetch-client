...
export function MosaicSupplyRevocationTransactionBodyDTOFromJSONTyped(
  json: any,
...
export function MosaicSupplyRevocationTransactionBodyDTOToJSONTyped(
  value?: MosaicSupplyRevocationTransactionBodyDTO | null,
