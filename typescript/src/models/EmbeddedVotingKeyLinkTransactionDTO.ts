...
export function EmbeddedVotingKeyLinkTransactionDTOFromJSONTyped(
  json: any,
...
export function EmbeddedVotingKeyLinkTransactionDTOToJSONTyped(
  value?: EmbeddedVotingKeyLinkTransactionDTO | null,
