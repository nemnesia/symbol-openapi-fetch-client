...
export function NamespaceMetadataTransactionBodyDTOFromJSONTyped(
  json: any,
...
export function NamespaceMetadataTransactionBodyDTOToJSONTyped(
  value?: NamespaceMetadataTransactionBodyDTO | null,
