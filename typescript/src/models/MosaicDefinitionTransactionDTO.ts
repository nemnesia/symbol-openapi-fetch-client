 ...
 */
export function instanceOfMosaicDefinitionTransactionDTO(value: object): value is MosaicDefinitionTransactionDTO {
...
export function MosaicDefinitionTransactionDTOToJSONTyped(
  value?: MosaicDefinitionTransactionDTO | null,
