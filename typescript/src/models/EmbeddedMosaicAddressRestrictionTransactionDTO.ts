 ...
 */
export function instanceOfEmbeddedMosaicAddressRestrictionTransactionDTO(
  value: object
): value is EmbeddedMosaicAddressRestrictionTransactionDTO {
...
export function EmbeddedMosaicAddressRestrictionTransactionDTOFromJSONTyped(
  json: any,
...
export function EmbeddedMosaicAddressRestrictionTransactionDTOToJSONTyped(
  value?: EmbeddedMosaicAddressRestrictionTransactionDTO | null,
