...
export function EmbeddedMosaicSupplyChangeTransactionDTOFromJSONTyped(
  json: any,
...
export function EmbeddedMosaicSupplyChangeTransactionDTOToJSONTyped(
  value?: EmbeddedMosaicSupplyChangeTransactionDTO | null,
