 ...
 */
export function instanceOfEmbeddedAccountMosaicRestrictionTransactionDTO(
  value: object
): value is EmbeddedAccountMosaicRestrictionTransactionDTO {
...
export function EmbeddedAccountMosaicRestrictionTransactionDTOFromJSONTyped(
  json: any,
...
export function EmbeddedAccountMosaicRestrictionTransactionDTOToJSONTyped(
  value?: EmbeddedAccountMosaicRestrictionTransactionDTO | null,
