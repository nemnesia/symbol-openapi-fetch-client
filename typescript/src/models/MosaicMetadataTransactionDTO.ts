 ...
 */
export function instanceOfMosaicMetadataTransactionDTO(value: object): value is MosaicMetadataTransactionDTO {
...
export function MosaicMetadataTransactionDTOToJSONTyped(
  value?: MosaicMetadataTransactionDTO | null,
