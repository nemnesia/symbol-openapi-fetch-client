...
export function MosaicGlobalRestrictionEntryRestrictionDTOFromJSONTyped(
  json: any,
...
export function MosaicGlobalRestrictionEntryRestrictionDTOToJSONTyped(
  value?: MosaicGlobalRestrictionEntryRestrictionDTO | null,
