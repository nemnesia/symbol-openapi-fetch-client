...
export function AggregateTransactionBodyExtendedDTOFromJSONTyped(
  json: any,
...
export function AggregateTransactionBodyExtendedDTOToJSONTyped(
  value?: AggregateTransactionBodyExtendedDTO | null,
