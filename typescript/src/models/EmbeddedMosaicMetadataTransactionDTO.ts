 ...
 */
export function instanceOfEmbeddedMosaicMetadataTransactionDTO(value: object): value is EmbeddedMosaicMetadataTransactionDTO {
...
export function EmbeddedMosaicMetadataTransactionDTOFromJSONTyped(
  json: any,
...
export function EmbeddedMosaicMetadataTransactionDTOToJSONTyped(
  value?: EmbeddedMosaicMetadataTransactionDTO | null,
