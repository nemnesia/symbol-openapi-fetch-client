 ...
 */
export function instanceOfSecretLockTransactionBodyDTO(value: object): value is SecretLockTransactionBodyDTO {
...
export function SecretLockTransactionBodyDTOToJSONTyped(
  value?: SecretLockTransactionBodyDTO | null,
