...
export function EmbeddedNamespaceMetadataTransactionDTOFromJSONTyped(
  json: any,
...
export function EmbeddedNamespaceMetadataTransactionDTOToJSONTyped(
  value?: EmbeddedNamespaceMetadataTransactionDTO | null,
