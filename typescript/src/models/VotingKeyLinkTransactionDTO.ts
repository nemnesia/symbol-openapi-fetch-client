 ...
 */
export function instanceOfVotingKeyLinkTransactionDTO(value: object): value is VotingKeyLinkTransactionDTO {
...
export function VotingKeyLinkTransactionDTOToJSONTyped(
  value?: VotingKeyLinkTransactionDTO | null,
