 ...
 */
export function instanceOfNamespaceMetadataTransactionDTO(value: object): value is NamespaceMetadataTransactionDTO {
...
export function NamespaceMetadataTransactionDTOToJSONTyped(
  value?: NamespaceMetadataTransactionDTO | null,
