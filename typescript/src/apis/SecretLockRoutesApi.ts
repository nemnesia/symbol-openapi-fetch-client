...
export class SecretLockRoutesApi extends runtime.BaseAPI {
   ...
   */
  async getSecretLockRaw(
    requestParameters: GetSecretLockRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SecretLockInfoDTO>> {
   ...
   */
  async getSecretLockMerkleRaw(
    requestParameters: GetSecretLockMerkleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   */
  async searchSecretLockRaw(
    requestParameters: SearchSecretLockRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SecretLockPage>> {
    const queryParameters: any = {};
   ...
   * Search secret lock entries
   */
  async searchSecretLock(
    requestParameters: SearchSecretLockRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SecretLockPage> {
