...
export class NamespaceRoutesApi extends runtime.BaseAPI {
  ...
  async getAccountsNamesRaw(
    ...
    if (requestParameters['addresses'] == null) {
      throw new runtime.RequiredError('addresses', 'Required parameter "addresses" was null or undefined when calling getAccountsNames().');
    }
  ...
  async getMosaicsNamesRaw(
    ...
    if (requestParameters['mosaicIds'] == null) {
      throw new runtime.RequiredError('mosaicIds', 'Required parameter "mosaicIds" was null or undefined when calling getMosaicsNames().');
    }
  ...
  async getNamespaceRaw(
    ...
    if (requestParameters['namespaceId'] == null) {
      throw new runtime.RequiredError('namespaceId', 'Required parameter "namespaceId" was null or undefined when calling getNamespace().');
    }
