...
export class MosaicRoutesApi extends runtime.BaseAPI {
   ...
   */
  async getMosaicRaw(
    requestParameters: GetMosaicRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<MosaicInfoDTO>> {
    if (requestParameters['mosaicId'] == null) {
      throw new runtime.RequiredError('mosaicId', 'Required parameter "mosaicId" was null or undefined when calling getMosaic().');
    }
   ...
   */
  async getMosaicMerkleRaw(
    requestParameters: GetMosaicMerkleRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<MerkleStateInfoDTO>> {
    if (requestParameters['mosaicId'] == null) {
      throw new runtime.RequiredError('mosaicId', 'Required parameter "mosaicId" was null or undefined when calling getMosaicMerkle().');
    }
   ...
   */
  async getMosaicsRaw(
    requestParameters: GetMosaicsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<MosaicInfoDTO>>> {
    if (requestParameters['mosaicIds'] == null) {
      throw new runtime.RequiredError('mosaicIds', 'Required parameter "mosaicIds" was null or undefined when calling getMosaics().');
    }
   ...
   * Search mosaics
   */
  async searchMosaicsRaw(
    requestParameters: SearchMosaicsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<MosaicPage>> {
    const queryParameters: any = {};
