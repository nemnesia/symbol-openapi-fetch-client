...
export class HashLockRoutesApi extends runtime.BaseAPI {
  ...
  async getHashLockRaw(
    ...
    if (requestParameters['hash'] == null) {
      throw new runtime.RequiredError('hash', 'Required parameter "hash" was null or undefined when calling getHashLock().');
    }
  ...
  async getHashLockMerkleRaw(
    ...
    if (requestParameters['hash'] == null) {
      throw new runtime.RequiredError('hash', 'Required parameter "hash" was null or undefined when calling getHashLockMerkle().');
    }
