...
export class TransactionRoutesApi extends runtime.BaseAPI {
   ...
   */
  async announceCosignatureTransactionRaw(
    requestParameters: AnnounceCosignatureTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AnnounceTransactionInfoDTO>> {
   ...
   * Announce a cosignature transaction
   */
  async announceCosignatureTransaction(
    requestParameters: AnnounceCosignatureTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   */
  async announcePartialTransactionRaw(
    requestParameters: AnnouncePartialTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AnnounceTransactionInfoDTO>> {
   ...
   * Announce an aggregate bonded transaction
   */
  async announcePartialTransaction(
    requestParameters: AnnouncePartialTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<AnnounceTransactionInfoDTO> {
   ...
   */
  async announceTransactionRaw(
    requestParameters: AnnounceTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<AnnounceTransactionInfoDTO>> {
    if (requestParameters['transactionPayload'] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async getConfirmedTransactionRaw(
    requestParameters: GetConfirmedTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TransactionInfoDTO>> {
   ...
   */
  async getConfirmedTransactionsRaw(
    requestParameters: GetConfirmedTransactionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<TransactionInfoDTO>>> {
   ...
   */
  async getPartialTransactionRaw(
    requestParameters: GetPartialTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TransactionInfoDTO>> {
    if (requestParameters['transactionId'] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async getPartialTransactionsRaw(
    requestParameters: GetPartialTransactionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<TransactionInfoDTO>>> {
    if (requestParameters['transactionIds'] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async getUnconfirmedTransactionRaw(
    requestParameters: GetUnconfirmedTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TransactionInfoDTO>> {
    if (requestParameters['transactionId'] == null) {
      throw new runtime.RequiredError(
   ...
   * Get unconfirmed transaction information
   */
  async getUnconfirmedTransaction(
    requestParameters: GetUnconfirmedTransactionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<TransactionInfoDTO> {
   ...
   */
  async getUnconfirmedTransactionsRaw(
    requestParameters: GetUnconfirmedTransactionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<TransactionInfoDTO>>> {
    if (requestParameters['transactionIds'] == null) {
      throw new runtime.RequiredError(
   ...
   */
  async searchConfirmedTransactionsRaw(
    requestParameters: SearchConfirmedTransactionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TransactionPage>> {
    const queryParameters: any = {};
   ...
   * Search confirmed transactions
   */
  async searchConfirmedTransactions(
    requestParameters: SearchConfirmedTransactionsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   */
  async searchPartialTransactionsRaw(
    requestParameters: SearchPartialTransactionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TransactionPage>> {
    const queryParameters: any = {};
   ...
   * Search partial transactions
   */
  async searchPartialTransactions(
    requestParameters: SearchPartialTransactionsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<TransactionPage> {
   ...
   */
  async searchUnconfirmedTransactionsRaw(
    requestParameters: SearchUnconfirmedTransactionsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<TransactionPage>> {
    const queryParameters: any = {};
   ...
   * Search unconfirmed transactions
   */
  async searchUnconfirmedTransactions(
    requestParameters: SearchUnconfirmedTransactionsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<TransactionPage> {
